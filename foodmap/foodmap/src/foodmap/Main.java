...
public class Main {
	...
	public void initializeData() {
		Restaurant Wang = new Restaurant(1, "왕십리 야식", "11:00~23:00", "041-564-2848", "연중무휴", "충남 천안시 동남구 병천면 병천리 162-1",
				"C:/Users/juhoj/Desktop/허명철 시발련/Foodmap/foodmap/src/reviews/review.txt");// 객체
		// 찍기
		Wang.SetMenu("../images/wang.png");// 메뉴사진등록
		Wang.SetPhoto("../images/store.png");// 가게사진 등록
		Wang.SetbigMenu("../images/bigwang.png");// 메뉴사진등록
		Wang.SetbigPhoto("../images/bigstore.png");// 가게사진 등록
		

		Restaurant Jeulgyeo = new Restaurant(2, "즐겨먹기", "11:00~20:00", "041-522-0122", "매주 토요일",
				"충남 천안시 동남구 병천면 충절로 1578","C:/Users/juhoj/Desktop/허명철 시발련/Foodmap/foodmap/src/reviews/review.txt");
		Jeulgyeo.SetMenu("../images/jeulgyeo.png");
		Jeulgyeo.SetPhoto("../images/store.png");
		Jeulgyeo.SetbigMenu("../images/bigjeulgyeo.png");
		Jeulgyeo.SetbigPhoto("../images/bigstore.png");

		Restaurant Hansot = new Restaurant(3, "한솥도시락", "09:00~21:00", "041-523-1123", "연중무휴",
				"충남 천안시 동남구 병천면 가전리 177-15","C:/Users/juhoj/Desktop/허명철 시발련/Foodmap/foodmap/src/reviews/review.txt");
		Hansot.SetMenu("../images/hansot.png");
		Hansot.SetPhoto("../images/hansotstore.png");
		Hansot.SetbigMenu("../images/bighansot.png");
		Hansot.SetbigPhoto("../images/bighansotstore.png");

		Restaurant Sseony = new Restaurant(4, "써니숯불도시락", "11:00~20:30", "041-554-8951", "연중무휴",
				"충남 천안시 동남구 병천면 가전리 206-3","C:/Users/juhoj/Desktop/허명철 시발련/Foodmap/foodmap/src/reviews/review.txt");
		Sseony.SetMenu("../images/sseony.png");
		Sseony.SetPhoto("../images/store.png");
		Sseony.SetbigMenu("../images/bigsseony.png");
		Sseony.SetbigPhoto("../images/bigstore.png");

		Restaurant Chowon = new Restaurant(5, "초원", "17:00~04:00", "041-569-4404", "연중무휴", "충남 천안시 동남구 병천면 가전8길 81",
				"C:/Users/juhoj/Desktop/허명철 시발련/Foodmap/foodmap/src/reviews/review.txt");
		Chowon.SetMenu("../images/chowon.png");
		Chowon.SetPhoto("../images/store.png");
		Chowon.SetbigMenu("../images/bigchowon.png");
		Chowon.SetbigPhoto("../images/bigstore.png");
		...
		Yong.SetbigMenu("../images/bigstore.png");
		Yong.SetbigPhoto("../images/bigyongstore.png");
		...
		Soosin.SetbigMenu("../images/bigsoosin.png");
		Soosin.SetbigPhoto("../images/bigsoosinstore.png");

		Restaurant Bohwa = new Restaurant(8, "보화 중화요리", "10:00~20:00", "041-569-3703", "정보 미등록",
				"충남 천안시 동남구 병천면 충절로 1700","C:/Users/juhoj/Desktop/허명철 시발련/Foodmap/foodmap/src/reviews/review.txt");
		Bohwa.SetMenu("../images/store.png");
		Bohwa.SetPhoto("../images/bohwa.png");
		Bohwa.SetbigMenu("../images/bigstore.png");
		Bohwa.SetbigPhoto("../images/bigbohwa.png");
		...
		Yogit.SetbigMenu("../images/bigyogit.png");
		Yogit.SetbigPhoto("../images/bigyogitstore.png");

		Restaurant Sinjeon = new Restaurant(10, "신전떡볶이", "11:00~23:40", "041-552-5512", "매주 토요일",
				"충남 천안시 동남구 병천면 가전6길 6","C:/Users/juhoj/Desktop/허명철 시발련/Foodmap/foodmap/src/reviews/review.txt");
		Sinjeon.SetMenu("../images/sinjeon.png");
		Sinjeon.SetPhoto("../images/sinjeonstore.png");
		Sinjeon.SetbigMenu("../images/bigsinjeon.png");
		Sinjeon.SetbigPhoto("../images/bigsinjeonstore.png");
		...
		Well.SetbigMenu("../images/bigwell.png");
		Well.SetbigPhoto("../images/bigwellstore.png");
